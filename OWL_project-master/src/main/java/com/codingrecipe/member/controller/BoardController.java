...
public class BoardController {
    ...
    public String boardDelete(Integer id, Model model, HttpSession session) {
        String loginEmail = (String) session.getAttribute("loginEmail");
        Board board = boardService.boardView(id);

        if (loginEmail != null && (loginEmail.equals(board.getWriter()) || loginEmail.equals("ADMIN_EMAIL"))) {
    ...
    public String boardModify(@PathVariable("id") Integer id, Model model, HttpSession session) {
        ...
        if (loginEmail != null && loginEmail.equals(board.getWriter())) {
